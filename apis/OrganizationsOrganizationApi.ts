...
export class OrganizationsOrganizationApi extends BaseAPI {
    ...
    getOrganization({ organizationGuid }: GetOrganizationRequest, opts?: OperationOpts): Observable<AjaxResponse<OrganizationOrganizationModel>>
    getOrganization({ organizationGuid }: GetOrganizationRequest, opts?: OperationOpts): Observable<OrganizationOrganizationModel | AjaxResponse<OrganizationOrganizationModel>> {
    ...
    updateOrganization({ organizationGuid, patchOrganizationOrganizationModel }: UpdateOrganizationRequest, opts?: OperationOpts): Observable<AjaxResponse<OrganizationOrganizationModel>>
    updateOrganization({ organizationGuid, patchOrganizationOrganizationModel }: UpdateOrganizationRequest, opts?: OperationOpts): Observable<OrganizationOrganizationModel | AjaxResponse<OrganizationOrganizationModel>> {
