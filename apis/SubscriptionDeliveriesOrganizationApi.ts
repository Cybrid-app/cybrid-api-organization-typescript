 ...
 *
 * The version of the OpenAPI document: v0.129.1047
...
export class SubscriptionDeliveriesOrganizationApi extends BaseAPI {
     ...
     */
    listSubscriptionDeliveries({ page, perPage, guid, subscriptionEventGuid, subscriptionGuid, state, eventType, completedAtGte, completedAtLt }: ListSubscriptionDeliveriesRequest): Observable<SubscriptionDeliveryListOrganizationModel>
    listSubscriptionDeliveries({ page, perPage, guid, subscriptionEventGuid, subscriptionGuid, state, eventType, completedAtGte, completedAtLt }: ListSubscriptionDeliveriesRequest, opts?: OperationOpts): Observable<AjaxResponse<SubscriptionDeliveryListOrganizationModel>>
    listSubscriptionDeliveries({ page, perPage, guid, subscriptionEventGuid, subscriptionGuid, state, eventType, completedAtGte, completedAtLt }: ListSubscriptionDeliveriesRequest, opts?: OperationOpts): Observable<SubscriptionDeliveryListOrganizationModel | AjaxResponse<SubscriptionDeliveryListOrganizationModel>> {
        ...
        if (completedAtGte != null) { query['completed_at_gte'] = completedAtGte; }
        if (completedAtLt != null) { query['completed_at_lt'] = completedAtLt; }
