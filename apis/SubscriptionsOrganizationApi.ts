...
export class SubscriptionsOrganizationApi extends BaseAPI {
     ...
     * Get Subscription 
     */
    getSubscription({ subscriptionGuid, includeSigningKey }: GetSubscriptionRequest): Observable<SubscriptionOrganizationModel>
    getSubscription({ subscriptionGuid, includeSigningKey }: GetSubscriptionRequest, opts?: OperationOpts): Observable<AjaxResponse<SubscriptionOrganizationModel>>
    getSubscription({ subscriptionGuid, includeSigningKey }: GetSubscriptionRequest, opts?: OperationOpts): Observable<SubscriptionOrganizationModel | AjaxResponse<SubscriptionOrganizationModel>> {
        ...
        if (includeSigningKey != null) { query['include_signing_key'] = includeSigningKey; }
     ...
     */
    listSubscriptions({ page, perPage, guid, includeSigningKey }: ListSubscriptionsRequest): Observable<SubscriptionListOrganizationModel>
    listSubscriptions({ page, perPage, guid, includeSigningKey }: ListSubscriptionsRequest, opts?: OperationOpts): Observable<AjaxResponse<SubscriptionListOrganizationModel>>
    listSubscriptions({ page, perPage, guid, includeSigningKey }: ListSubscriptionsRequest, opts?: OperationOpts): Observable<SubscriptionListOrganizationModel | AjaxResponse<SubscriptionListOrganizationModel>> {
