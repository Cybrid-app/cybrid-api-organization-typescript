...
export interface SubscriptionOrganizationModel {
     ...
     * @memberof SubscriptionOrganizationModel
     */
    type: SubscriptionOrganizationModelTypeEnum;
    /**
     ...
     * @memberof SubscriptionOrganizationModel
     */
    deliveries_failing_since?: string | null;
    /**
 ...
 * @enum {string}
 */
export enum SubscriptionOrganizationModelTypeEnum {
    Webhook = 'webhook',
    Email = 'email'
}
